...
const DashboardSidebar = ({
  ...
  const handleDelete = async (e: React.MouseEvent, id: string) => {
    ...
    // 2. If active session was deleted, switch to new chat immediately
              ...
              {sessions.map((session) => {
                ...
                return (
                  <SidebarMenuItem key={session.id} className="relative group/item">
                    <SidebarMenuButton
                      className={`relative flex items-center gap-2.5 px-3 py-2 rounded-lg cursor-pointer transition-all duration-150 pr-8
                        ${isActive
                    ...
                    {/* Delete action button outside the menu button */}
                    <button
                      type="button"
